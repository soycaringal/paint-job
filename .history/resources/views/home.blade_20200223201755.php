    ...
    <form action="{{route('car.store')}}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-8   ">
                <select 
                    name="current_color" 
                    class="current-color form-control" 
                    onchange="changeColor('current', this)" 
                    required
                >
                    <option value=""></option>
        ...
        <div class="form-group row">
            ...
            <div class="col-8   ">
                <select name="target_color" class="target-color form-control" onchange="changeColor('target', this)" required>
                    <option value=""></option>
                    <option value="red">Red</option>
                    <option value="green">Green</option>
                    <option value="blue">Blue</option>
